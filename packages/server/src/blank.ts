 ...
 * documents blank (no user-supplied import — a threat-model decision for the
 * public demo, plan doc 11). */
export function blankDocxBytes(): Uint8Array {
  const documentXml =
...
export const blankProvider: DocProvider = { load: () => blankDocxBytes() };
