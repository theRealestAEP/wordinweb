// Shard 3 of 8. One file per shard is the whole point: vitest hands work
...
describe.runIf(AUDIT_ENABLED)("agent representation parity corpus (shard 3/8)", () => {
  it("represents every semantic component and every laid-out page in its slice", async () => {
    await auditCorpusShard(3, 8);
  });
});
