# How DocxInWeb reaches Word parity

DocxInWeb renders `.docx` files in the browser and edits them. No server, no
...
DocxInWeb reimplements the layout engine and uses the browser only to paint.
